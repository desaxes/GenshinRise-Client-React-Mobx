        ...
        return (
            ...
            >
                ...
                <Modal.Body
                    ...
                    <StyledImg width={'125px'} bg={char.stars === 5 ? 'orange' : '#4600f6'} src={process.env.REACT_APP_API_URL + "/chars/" + char.img}></StyledImg>
                    ...
                    <Row md={'auto'}>
                        <Col md={'auto'}>
                            ...
                            <RiseBar
                                counter={setBmat}
                                materialBase={4} materialId={char.bossMaterialId} quality={0} current={bmat} max={max ? max.bossMaterialCount : 46} />
                        </Col>
                        <Col md={'auto'}>
                            <RiseBar
                                counter={setEmat1}
                                materialBase={3} materialId={char.enemyMaterialId} quality={1} current={emat1} max={max ? max.enemyMaterial1Count : 18} />
                            <RiseBar
                                counter={setEmat2}
                                materialBase={3} materialId={char.enemyMaterialId} quality={2} current={emat2} max={max ? max.enemyMaterial2Count : 30} />
                            <RiseBar
                                counter={setEmat3}
                                materialBase={3} materialId={char.enemyMaterialId} quality={3} current={emat3} max={max ? max.enemyMaterial3Count : 36} />
                            <RiseBar
                                counter={setSpec}
                    ...
                    <Row md={'auto'}>
                        <Col md={'auto'}>
                            ...
                            <RiseBar
                                counter={setWbmat}
                                materialBase={6} materialId={char.weekBossMaterialId} quality={0} current={wbmat} max={max ? max.weekBossMaterialCount : 18} />
                        </Col>
                        <Col md={'auto'}>
                            <RiseBar
                                counter={setTalent1}
                                materialBase={5} materialId={char.talentMaterialId} quality={1} current={talent1} max={max ? max.talentMaterial1Count : 9} />
                            <RiseBar
                                counter={setTalent2}
                                materialBase={5} materialId={char.talentMaterialId} quality={2} current={talent2} max={max ? max.talentMaterial2Count : 63} />
                            <RiseBar
                                counter={setTalent3}
                                materialBase={5} materialId={char.talentMaterialId} quality={3} current={talent3} max={max ? max.talentMaterial3Count : 114} />
                        </Col>
                    </Row>
                </Modal.Body>
