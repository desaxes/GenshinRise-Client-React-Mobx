    ...
    return (
        <div>
            <Container className='d-flex mt-5 flex-column'>
                <Button onClick={() => setModalStoneShow(true)}
                ...
                <Button onClick={() => setModalLSShow(true)}
                    className='mt-3 p-4' variant='outline-warning'><h2>Добавить Диковинку</h2></Button>
                <Button onClick={() => setModalTalentShow(true)}
                    className='mt-3 p-4' variant='outline-warning'><h2>Добавить Книгу Талантов</h2></Button>
